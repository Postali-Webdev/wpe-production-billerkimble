    ...
    <div class="container">
        <div class="columns">
            <div class="column-full">
                ...
                if($resultsList->have_posts()) : ?>
                    <div class="case-card-holder">
                    <?php
                    
                    while($resultsList->have_posts()) : $resultsList->the_post(); 
                ...
                <?php if ($resultsList->max_num_pages > 1) : ?>
                    <div class="pagination">
                        <?php 
                        $orig_query = $wp_query;
                        $wp_query = $resultsList;
